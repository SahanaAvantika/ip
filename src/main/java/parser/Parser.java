...
public class Parser {
    ...
    public static Commands update(String response) {
        try {
    ...
    public static Commands find(String response) {
        try {
    ...
    public static Commands mark(String response) {
        try {
    ...
    public static Commands unmark(String response) {
        try {
    ...
    public static Commands delete(String response) {
        try {
    ...
    public static Commands todo(String response) {
        try {
    ...
    public static Commands deadline(String response) {
        try {
    ...
    public static Commands event(String response) {
        try {
